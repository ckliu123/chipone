...
#define THP_LOGE(...) cts_thp_log(THP_LOG_ERROR, __func__, ## __VA_ARGS__)
#define THP_LOGW(...) cts_thp_log(THP_LOG_WARNING, __func__, ## __VA_ARGS__)
#define THP_LOGI(...) cts_thp_log(THP_LOG_INFO, __func__, ## __VA_ARGS__)
#define THP_LOGD(...) cts_thp_log(THP_LOG_DEBUG, __func__, ## __VA_ARGS__)
//#define THP_LOGE All_LOG
//#define THP_LOGW All_LOG
//#define THP_LOGI All_LOG
//#define THP_LOGD All_LOG
//sguo add Release 20240621
#define RELEASE
