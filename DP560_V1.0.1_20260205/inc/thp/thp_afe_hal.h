...
typedef enum {
    ...
    THP_AFE_STATUS_FOLD_COMPEN_REQUEST = (1 << 4),      // 4:0x000010 /* -->default: THP_AFE_STATUS_GESTURE_DETECTED / Indicate wakeup gesture is detected */
    ...
    THP_AFE_STATUS_OSC_TRIM_TRIGGER = (1 << 13), 	// mutipul /* Chipone for hsync osc shift trigger */
    //THP_AFE_STATUS_FORCE_ABNORMAL = (1 << 14),      // 14:0x004000 /* Indicate force sensor is broken */
    THP_AFE_STATUS_XTAL_CLK = (1 << 14),			// mutipul /* Chipone for Xtal clock */
    //THP_AFE_STATUS_SIDE_IDLE_MODE = (1 << 15),      // 15:0x008000 /* Indicate AFE is running in SideIdle mode */
    THP_AFE_STATUS_FOLD_COMPEN_DONE = (1 << 15),      // 15:0x008000 /* THP_AFE_STATUS_FOLD_COMPEN_DONE  */
	...
	THP_AFE_STATUS_XTAL_REQUEST = (1 << 21),      // FOLD request for hal afe status */
	THP_AFE_STATUS_FOLD_COMPEN_REQUEST_FOR_HAL = (1 << 27),      // FOLD request for hal afe status */
    THP_AFE_STATUS_FOLD_COMPEN_DONE_FOR_HAL = (1 << 28),      // afe fold compen done for hal afe status */
    THP_AFE_STATUS_FOLD_COMPEN_DONE_HAL_FLAG = (1 << 29),      // HAL compen done flag for hal afe status */
    THP_AFE_STATUS_FOLD_COMPEN_DONE_FW_FLAG = (1 << 30),      // FW compen done flag for hal afe status */
    THP_AFE_STATUS_FOLD_COMPEN_NOT_DONE_FLAG = (1 << 31), 
} THP_AFE_STATUS_ENUM;
 ...
 *   called next time.
 *****************************************************************************/
uint16_t *thp_afe_get_inspect_full_raw_data(void);
...
*****************************************************************************/
uint8_t thp_afe_get_support_clock(void);
...
* 0: RC source, 1: xtal
*****************************************************************************/
uint8_t thp_afe_get_cur_clock(void);
...
*
*****************************************************************************/
void thp_afe_set_cur_clock(uint8_t clock);
...
*
*****************************************************************************/
void thp_afe_vendor_call(uint32_t value);
